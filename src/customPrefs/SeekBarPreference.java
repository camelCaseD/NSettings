...
/*
 * Copyright (c) 2003 - 2011 Sileria, Inc.
 *
...
public class SeekBarPreference extends Preference implements SeekBar.OnSeekBarChangeListener {
	...
	private int max = 100;
	private int keyIncrementProgress = 1;
	...
	/**
	 * Sets the keyIncrementProgress
	 * @param keyIncrementProgressValue value
	 */
	public void setKeyIncrementProgress(int keyIncrementProgress) {
		this.keyIncrementProgress = keyIncrementProgress;
		if (seekbar != null)
			seekbar.setKeyProgressIncrement(keyIncrementProgress);
	}
	
	public void incrementProgressBy(int porgress) {
		if(seekbar != null)
			seekbar.incrementProgressBy(progress);
	}
	
	/**
	 * Sets the onProgressChangeListener
	 * @params listener
	 */
	...
	public static abstract class AbstractSeekBarListener extends PrefsChangeListener<SeekBarPreference> {
		 ...
		 * to avoid {@link com.sileria.android.SeekBarPreference#notifyChanged()} call
